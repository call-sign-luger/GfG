<h2><a href="https://www.geeksforgeeks.org/problems/count-the-substring--170645/1?page=1&category=Strings&difficulty=Hard&sortBy=submissions">Count the Substring</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary string&nbsp;<strong>S</strong>&nbsp;consists only of 0s and 1s. The task is to calculate the number of substrings that have more 1s than 0s.</span></p>
